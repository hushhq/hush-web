...
const milestones = [
  ...
  },
  {
    ...
    status: "planned",
    summary: "Discord-like community structure. Servers, text and voice channels, invites, moderation.",
    tasks: [
      "Server creation, membership, and role-based permissions",
      "Text channels with Signal-encrypted messaging",
      "Always-on voice channels (join/leave freely, no calls to start)",
