...
type MilestoneStatus = "done" | "active" | "planned" | "future"
...
function releasesForMilestone(milestoneId: string): Release[] {
  return (releases as Release[]).filter(
    (r: Release) => r.milestone === milestoneId
  )
}
...
export function RoadmapPage({ onBack }: RoadmapPageProps) {
  ...
  const sorted = React.useMemo(
    () => [...(milestones as Milestone[])].reverse(),
    []
  )
