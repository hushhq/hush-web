...
export function BottomDock({
  ...
  return (
    <div className="flex w-full flex-col gap-1">
      ...
      >
        {/* The bug-report button sits above the user-menu trigger so it
            reads as a global utility action even when the voice pip is
            mounted directly below the dock header. Icon-only width and
            shrink-0 keep neighbouring controls from re-laying-out when
