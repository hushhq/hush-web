...
import App from './App';
// NOTE(2026-05-04): Radix Themes runtime <Theme> wrapper removed; the styles.css
// import stays to keep legacy components visually intact until Phase 7 deletes
// every `@radix-ui/themes` consumer.
